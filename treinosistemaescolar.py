...
# CLASSE (orientação a objetos) Aluno, adicionar_nota, media (para adcionar algo em lista usa o append)(tratar media)
class Aluno:
...
# SET (evitar nomes repetidos) nomes_unicos
nomes_unicos = set()

# Salvar arquivos salvar_arquivo
def salvar_arquivo():
...
# Carregar arquivos carregar_arquivo ( errei na criação de class "int", e no eval)
...
#iniciar programa com nome do programa, versão, data e hora
print(f"{CONFIG[0]} Versão {CONFIG[1]}")
